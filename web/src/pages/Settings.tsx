  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Configure gateway settings and preferences</p>
      </div>
        ...
        <TabsContent value="general" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure basic gateway settings</CardDescription>
            </CardHeader>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="db-url" type="password" placeholder="postgresql://user:pass@localhost/db" />
              </div>
              <div className="space-y-2">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Send email for critical issues</p>
                </div>
